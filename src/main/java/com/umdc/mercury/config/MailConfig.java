...
public class MailConfig {
    ...
    public JavaMailSender getJavaMailSender(){
        ...
        props.put("mail.smtp.auth", parseBoolean(auth, true));
        props.put("mail.smtp.starttls.enable", parseBoolean(starttls, true));
    ...
    public boolean isStarttls() {
        return parseBoolean(starttls, true);
    }

    public boolean isAuth() {
        return parseBoolean(auth, true);
    }
