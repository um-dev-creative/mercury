...
- `../../../src/main/java/com/umdc/mercury/security/SessionJwtServiceImpl.java` — JWT token generation
- `../../../src/main/java/com/umdc/mercury/client/BackboneClient.java` — Feign client for session validation
- `../../../src/main/java/com/umdc/mercury/client/interceptor/BackendFeignClientInterceptor.java` — request auth injection
- `../../../src/main/java/com/umdc/mercury/api/v1/service/AuthServiceImpl.java` — auth orchestration
- `../../../src/main/java/com/umdc/mercury/api/v1/exception/ForbiddenException.java` — auth exception
